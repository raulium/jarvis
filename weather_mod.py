...
from interaction_mod import saiff, GREAT, GOOD, OKAY, BAD
from timing_mod import whatSeason
# ============== EXTERNAL LIBRARIES
import json, email, math, random
...
def newDailyReport():
	...
	if feels_like < temp:
		weather_string = "Though the temperature is " + str(temp) + ", it feels like " + str(feels_like) + " degrees.  It's expected to reach " + str(high) + " today, with a low of " + str(low) + "."
	else:
		weather_string = "The temperature is " + str(temp) + " degrees, with a high of " + str(high) + " and a low of " + str(low) + "."
